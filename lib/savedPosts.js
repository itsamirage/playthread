  ...
  useEffect(() => {
    ...
    const loadComments = async () => {
      ...
      try {
        ...
        const { data, error: nextError } = await supabase
          .from("post_comments")
          .select("id, post_id, user_id, body, image_url, link_url, link_label, moderation_state, moderation_labels, created_at, updated_at, posts(id, title, igdb_game_id, game_title), profiles(username, display_name, selected_title_key, selected_name_color)")
