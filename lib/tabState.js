...
export function resolveTabKeyFromPath(pathname) {
  ...
  if (pathname === "/popular" || pathname.startsWith("/popular/") || pathname.startsWith("/(tabs)/popular")) {
    return "all";
  }

  if (pathname === "/browse" || pathname.startsWith("/browse/") || pathname.startsWith("/(tabs)/browse")) {
    return "browse";
  }

  if (pathname === "/friends" || pathname.startsWith("/friends/") || pathname.startsWith("/(tabs)/friends")) {
    return "friends";
  }

  if (pathname === "/profile" || pathname.startsWith("/profile/") || pathname.startsWith("/(tabs)/profile")) {
    return "profile";
  }
